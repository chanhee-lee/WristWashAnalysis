...
def cm(testfilename): 
	...
	for target_participant_counter in xrange(1,2):
		test_file = '../raw/participant' + str(target_participant_counter) + '/' + testfilename + '.csv'
	...
	print "Score 1: " + str(modelClassifier.score(X_test, Y_test))
	# WANT x_test and y_test to be gesture 
