...
for gdata_number in xrange(1,7):
    participant_file = "../raw/participant" + args.pnumber + "/tc_ss_accel_gyro_label_" + gdata_number + ".csv"
...
savetxt("../raw/participant" + args.pnumber + "/gestures_combined_" + gdata_number + ".csv", Z, delimiter=",")
